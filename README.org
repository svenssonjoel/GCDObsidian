...
* TODO Fix SyncAnalysis
* TODO Perform CSE
* TODO Kernel Coordination layer
* TODO Generate the vSwap/iSwap kind of kernels. That is Kernels that operate 
       on an array based on its global tid instead of local tid.
* TODO Generate Kernels that take scalar parameters
